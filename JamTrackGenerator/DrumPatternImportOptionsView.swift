...
struct DrumPatternImportOptionsView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            trackNotes.forEach { track in
                ...
                customNames[track] = "" // Initialize empty custom name
            }
    ...
    private func importSelectedTracks() {
        ...
        for track in selected {
            // Use custom name if provided, else fall back to track name or default
...
#Preview {
    ...
    return DrumPatternImportOptionsView(trackNotes: trackNotes, selectedDrumPatternNavigation: .constant(nil))
