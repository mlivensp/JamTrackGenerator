...
////        Pattern(chorus: pattern05Chorus(jamTrack: definition))
////    }
//    
//    func pattern05Chorus(jamTrack: JamTrack) -> [DrumDescriptor] {
//        var events: [DrumDescriptor] = []
//        var pulseAtMeasureStart: UInt32 = 0
//        var counter = 0
//        // bars 1-4
//        events.append(contentsOf: createPattern0Measure(jamTrack: definition, pulseAtMeasureStart: pulseAtMeasureStart))
...
//    }
//    
//    fileprivate func createPattern0Measure(jamTrack: JamTrack, pulseAtMeasureStart: UInt32) -> [DrumDescriptor] {
